...
\begin{document}
\hspace{0.5cm}\\[-0.2cm]
\indent \begin{minipage}{0.3\textwidth}
    \begin{flushleft}
       \indent\textbf{John Doe} \\
       \indent\textbf {Electrical Engineering}\\ 
       \indent\textbf {Indian Institute of Technology Bombay}\\
    \end{flushleft}
\end{minipage} \hfill
\begin{minipage}{0.3\textwidth}
    \begin{flushleft}
        \indent \textbf{Mobile No.:} \textbf{1234567890} \\
        \indent \textbf{Email-id :} \textbf{someone@email.com} \\
        \indent \textbf{Male}\\
        \indent \textbf{DOB:} \textbf{ 26/7/2002} \\
    \end{flushleft}
\end{minipage} \\
...
\item \noindent Playing Chess.\item \noindent Hacking \item \noindent people
